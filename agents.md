# AI Agent Guidelines for Clockwork
...
- **Note:** This repository is a fork and is in Archived/Legacy mode
...
- This is a fork of the Clockwork project - be aware of upstream license obligations
...
- This app requires ownCloud debug mode to be enabled
